...
// Blur + opacity reveal — more cinematic than translate
...
const PhoneScreen: React.FC<{ f: number }> = ({ f }) => {
  // Elements animate in relative to scene frame
